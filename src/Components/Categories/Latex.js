    ...
    return (
        <Page>
            <ContainerProducts>
                ...
                {latexProducts.map((product, key) => <ProductsJSX key={key} name={product.name} description={product.description} image={product.image} price={product.price} id={product._id} token={context.userInfo} navigate={navigate} postAddCart={context.postAddCart} />)}
